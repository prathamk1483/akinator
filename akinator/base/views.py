...
def filtercharlist(lastkeyword,lastanswer,charlist):
    ...
    if lastanswer == 'Yes':
        ...
        return
    # print("printed by filterccharlist lastanswer is",lastanswer)
    for i in charlist:
        # print(i[lastkeyword])
...
def playgame(request):
    global qlist
    # print("qlist by playgame :",qlist)
    # print("length qlist by playgame :",len(qlist))
    global charlist
    global question 
    global lastkeyword
    global lastanswer
    ...
    print("lastkeyword :",lastkeyword,"Last answer :",lastanswer)
    try:
    ...
    print("value got by function :",lastanswer)
    # print("lastanswer after submission :",lastanswer)
    qlist.remove(question)
    # print("charlist after a submission :",charlist)
    # print("the length of the charlist is :",len(charlist))
    if len(charlist)==1:
        # return HttpResponse(f"Character is :{charlist[0]['name']}")
...
def obj(request):
    return HttpResponse("welcome to object game ")
def ani(request):
    return HttpResponse("welcome to animal game")
